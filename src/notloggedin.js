...
const Notloggedin = () => {
    ...
    return (
        <div>
            ...
            <button className='closebtn' style={{position: 'relative', backgroundColor: 'transparent', border: 'none', top: '40px',left:'1068px'}} type="button" data-bs-dismiss="modal" aria-label="Close"><img alt='close' src={modalcloseicon} /></button>
